...
import { Button1, Text } from "../../styles/Components.styled";
...
const NavigatorTab = (props: INavigatorTab) => {
  return (
    <LinkContainer style={{ cursor: "pointer" }} onClick={props.onClick}>
      {props.text}
    </LinkContainer>
  );
};
...
const UnsignedComponent = () => {
  ...
  return (
    <UnsignedContainer>
      <SteamImage>
        <Image alt="Steam" src="/steam.svg" layout="fill" />
      </SteamImage>

      <VerifyText>
        To start earning rewards and buy Our nfts, the players have to link
        their steam account to orbeem ECosystem. This is done by minting a
        unique avatar nft. please enter the following data into the
